/*
  # Sample Blog Content Migration

  1. Sample Data
    - Categories for organizing blog posts
    - Tags for post classification
    - Sample blog post with markdown content
    - Tag relationships for the post

  2. Note: User creation is handled separately through auth system
*/
